...
| 3 | - Tìm hiểu MongoDB: cài đặt local, thực hành CRUD, aggregation, indexing.<br>- Tìm hiểu Vue.js: component, Vue Router, Pinia (state management). | 28/10/2025 | 28/10/2025 | MongoDB Docs<br>Vue.js Guide | |
| 4 | - Tìm hiểu Nest.js: module, controller, service, DTO, JWT auth.<br>- Tìm hiểu Socket.IO: WebSocket, rooms, events, real-time messaging. | 29/10/2025 | 29/10/2025 | NestJS Docs<br>Socket.IO Docs | Backend & real-time |
| 5 | - Tìm hiểu Docker: Dockerfile, docker-compose, multi-container app.<br>- Bàn dự án nhóm: phân chia công việc (frontend, backend, DevOps).<br>- Điều chỉnh worklog theo tiến độ nhóm. | 30/10/2025 | 30/10/2025 | Docker Docs<br>Team Meeting | |
| 6 | - Tạo repository Git (GitHub/GitLab).<br>| 31/10/2025 | 31/10/2025 | GitHub<br>GitHub Pages Guide | |
