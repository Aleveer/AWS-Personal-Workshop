...
| --- | ---- | ---------- | --------------- | ------------------ | ---- |
| 2 | - Review Lab 000001.<br>- Complete Lab 000007: Manage costs with AWS Budgets – create budgets using templates for Cost, Usage, and Savings Plans.<br>- Perform cleanup of created resources.<br>- (Earn $20 reward upon Budget creation) | 09/15/2025 | 09/15/2025 | AWS Budgets Console<br>[AWS Cost Management Docs](https://docs.aws.amazon.com/cost-management/) | Cost control & cleanup |
...
| 4 | - Complete Lab 000003.3:<br> • Create VPC<br> • Create Public and Private Subnets<br> • Attach Internet Gateway<br> • Configure Route Table<br> • Create Security Groups | 09/17/2025 | 09/17/2025 | Lab Guide 000003.3<br>AWS VPC Console | Network foundation setup |
| 5 | - Continue Lab 000003 (remaining parts):<br> • Launch EC2 instances in Public and Private Subnets<br> • SSH into Public EC2 → Private EC2<br> • Test Internet connectivity from both instances<br> • Use Reachability Analyzer to verify connectivity between the two EC2s | 09/18/2025 | 09/18/2025 | Lab Guide 000003<br>[Reachability Analyzer Docs](https://docs.aws.amazon.com/vpc/latest/reachability/) | EC2 networking & troubleshooting |
| 6 | - Practice and compare 3 EC2 connection methods:<br> 1. Bastion Host (Jump Server)<br> 2. VPC Interface Endpoint + EC2 Instance Connect<br> 3. AWS Systems Manager – Session Manager<br>- Document pros/cons and security implications | 09/19/2025 | 09/19/2025 | [Session Manager Docs](https://docs.aws.amazon.com/systems-manager/latest/userguide/session-manager.html)<br>[EC2 Connect Endpoint](https://docs.aws.amazon.com/vpc/latest/privatelink/endpoint-services-overview.html) | Secure remote access |
